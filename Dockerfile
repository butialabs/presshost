...
ENV TZ=UTC \
    ...
    NGINX_CACHE_VALID_OK=60m \
    NGINX_CACHE_VALID_NOT_FOUND=1m \
    NGINX_CACHE_KEY_ZONE_SIZE=100m \
    ...
    NGINX_RATE_BURST=60 \
    NGINX_CONN_LIMIT=50 \
    NGINX_LOGIN_RATE_LIMIT=5r/m \
    NGINX_LOGIN_BURST=10 \
    NGINX_WORKER_PROCESSES=auto \
    NGINX_WORKER_CONNECTIONS=65535 \
    NGINX_WORKER_RLIMIT_NOFILE=65535 \
    NGINX_RESOLVER="127.0.0.11 valid=30s" \
    NGINX_HTTP3=false \
    NGINX_HSTS=true \
    NGINX_HSTS_MAX_AGE=31536000 \
    NGINX_HSTS_SUBDOMAINS=true \
    NGINX_HSTS_PRELOAD=false \
    NGINX_BLOCK_SPAM=false \
    NGINX_CDN_CACHE=false \
    NGINX_CDN_EDGE_TTL=3600 \
    NGINX_CDN_BROWSER_TTL=60 \
    NGINX_CDN_SWR=60 \
    NGINX_CDN_STALE_IF_ERROR=86400 \
    NGINX_CLOUDFLARE_REAL_IP=false \
    NGINX_REAL_IP_HEADER=X-Forwarded-For \
    NGINX_REAL_IP_FROM="" \
    NGINX_ORIGIN_AUTH_SECRET="" \
